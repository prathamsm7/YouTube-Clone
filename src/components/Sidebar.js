...
const Sidebar = () => {
  ...
  return (
    <div
      className={`transform top-[88px] left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30
 ${isMenuOpen} ? 'translate-x-0' : '-translate-x-full'`}
    >
      <ul className='flex flex-col gap-3 pl-[30px] text-slate-700'>
      ...
      <ul className='flex flex-col gap-3 text-slate-700 pl-[30px]'>
